                ...
                <div className="space-y-4 w-full">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-center gap-2">
                            <h1 className="text-2xl font-bold">MiteshAI</h1>
                        ...
                        <p className="text-muted-foreground max-w-lg mx-auto">
                            Transformational Leadership Coach & Law of Attraction Expert Empowering Millions to Achieve Peak Success and Fulfillment with MiteshAI
                        </p>
