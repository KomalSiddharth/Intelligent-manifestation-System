                    ...
                    <div className="flex-1 overflow-y-auto w-full h-full pb-32">
                        ...
                        {isDisclaimerVisible && (
                            <div className="bg-orange-50 px-4 py-2 text-center text-xs md:text-sm text-orange-800 flex items-center justify-center gap-2 relative">
                                ...
                                <span>This is an AI assistant based on {selectedProfile?.name || 'our'} teachings and content. Responses are generated by AI and do not replace personalized coaching or professional advice.</span>
                                <button
                        ...
                        <header className="px-4 py-4 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center text-sm font-medium">
                                    {userFullDetails?.name ? userFullDetails.name[0].toUpperCase() : 'U'}
                                </div>
                        ...
                        <main className="max-w-3xl mx-auto w-full px-4 py-8 flex flex-col items-center text-center space-y-8">
                            ...
                            <div className="w-full text-left space-y-2 border-t pt-8">
                                ...
                                <div className="text-muted-foreground space-y-4 leading-relaxed">
                                    <p>
                                        {toDisplayText(selectedProfile?.description) || "Welcome to my AI support bot! Ask me anything."}
                                    </p>
                                    {isDescriptionExpanded && (
                                        <>
                                            <p>
                                                {toDisplayText(selectedProfile?.instructions, 500) || "This bot is trained on specialized knowledge bases to provide accurate, specific answers."}
                                            </p>
                                        </>
                                    )}
                                    <button
